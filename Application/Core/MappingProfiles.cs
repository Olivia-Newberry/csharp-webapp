    ...
    public class MappingProfiles : Profile
    {
        public MappingProfiles()
        {
            ...
            CreateMap<ActivityAttendee, AttendeeDto>()
                ...
                .ForMember(d => d.FollowedBy, o => o.MapFrom(s =>
                    s.AppUser.Followings.Any(x => x.Target.UserName == currentUsername)));
            CreateMap<AppUser, Profiles.Profile>()
                ...
                .ForMember(d => d.FollowedBy, o => o.MapFrom(s =>
                    s.Followings.Any(x => x.Target.UserName == currentUsername)));
